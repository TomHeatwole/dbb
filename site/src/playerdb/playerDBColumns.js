...
export const PLAYER_DB_COLUMNS = [
  ...
  // ── Hwang-adjusted KTC (stitched SF TE+ base) ────────────────────────────────
  {
    key: 'hwangMarketValue',
    label: 'Market Adj Val',
    sortable: true,
    sortFn: (a, b) => (b.hwangMarketValue ?? -1) - (a.hwangMarketValue ?? -1),
    align: 'right',
    mobileVisible: false,
    defaultVisible: true,
    width: '110px',
  },
  {
    ...
    label: 'Market Adj Rk',
    sortable: true,
    sortFn: (a, b) => (a.hwangMarketRank ?? 9999) - (b.hwangMarketRank ?? 9999),
    align: 'center',
    mobileVisible: false,
    defaultVisible: true,
    width: '105px',
  ...
  {
    key: 'hwangMarketPosRank',
    label: 'Market Pos Rk',
    sortable: true,
    sortFn: (a, b) => (a.hwangMarketPosRank ?? 9999) - (b.hwangMarketPosRank ?? 9999),
    align: 'center',
    mobileVisible: false,
    defaultVisible: false,
    width: '110px',
  },
  {
    ...
    label: 'True Adj Val',
    sortable: true,
    sortFn: (a, b) => (b.hwangTrueValue ?? -1) - (a.hwangTrueValue ?? -1),
    align: 'right',
    mobileVisible: false,
    defaultVisible: true,
    width: '105px',
  },
  {
    ...
    label: 'True Adj Rk',
    sortable: true,
    sortFn: (a, b) => (a.hwangTrueRank ?? 9999) - (b.hwangTrueRank ?? 9999),
    align: 'center',
    mobileVisible: false,
    defaultVisible: true,
    width: '100px',
  ...
  {
    key: 'hwangTruePosRank',
    label: 'True Pos Rk',
    sortable: true,
    sortFn: (a, b) => (a.hwangTruePosRank ?? 9999) - (b.hwangTruePosRank ?? 9999),
    align: 'center',
    mobileVisible: false,
    defaultVisible: false,
    width: '105px',
