...
function TeamPage() {
  ...
  useEffect(() => {
    ...
    // For past seasons, pass season string so fetchPlayersData loads static file (e.g. players_2025.txt).
    // For current season, pass rosters so it can extract player IDs for dynamic loading.
